...
export default function SanityCta({
  ...
  return (
    <Link
      href={href}
      className={`hover:opacity-70 transition inline-flex items-center gap-2 text-[1.66rem] font-body font-[inherit] not-italic leading-[inherit] tracking-[0] ${className}`}
