...
export default function NavContactButton({ className = '' }: NavContactButtonProps) {
  return (
    <Link
      href="/contact"
      className={`relative inline-flex items-center justify-center w-[158px] h-[60px] bg-white rounded-full text-black text-[14px] font-semibold font-['ABC_Diatype_Mono_Unlicensed_Trial'] leading-[72px] no-underline gap-0 ${className}`}
      style={{
        borderRadius: '184px',
    ...
    >
      <div style={{ width: '100px', height: '35px', display: 'flex', alignItems: 'center', justifyContent: 'center', lineHeight: '1' }}>Contact Us</div>
